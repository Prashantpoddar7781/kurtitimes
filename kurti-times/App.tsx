          ...
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center gap-3 mb-6">
              <svg width="32" height="32" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M35 30 V70" stroke="#be185d" strokeWidth="10" strokeLinecap="round" />
                <path d="M65 30 L35 50 L65 70" stroke="#be185d" strokeWidth="10" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
